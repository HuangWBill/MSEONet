...
_base_ = [
    ...
    '../_base_/datasets/Potsdam_my_dataset_512.py', '../_base_/default_runtime_iter.py',
    '../_base_/schedules/schedule_80k_iter.py'
]

custom_imports = dict(imports=['MSEONet.mmseg.datasets.Potsdam_my_dataset','MSEONet.mmseg.decode_head.msca_head','MSEONet.mmseg.decode_head.epfo_head'])
